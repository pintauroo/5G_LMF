...
typedef Ngap_LastVisitedCellInformation_ExtIEs_t
    Ngap_ProtocolIE_SingleContainer_127P10_t;
...
typedef Ngap_PWSFailedCellIDList_ExtIEs_t
    Ngap_ProtocolIE_SingleContainer_127P15_t;
typedef Ngap_QosCharacteristics_ExtIEs_t
    Ngap_ProtocolIE_SingleContainer_127P16_t;
...
typedef Ngap_UEIdentityIndexValue_ExtIEs_t
    Ngap_ProtocolIE_SingleContainer_127P20_t;
...
typedef Ngap_UPTransportLayerInformation_ExtIEs_t
    Ngap_ProtocolIE_SingleContainer_127P23_t;
typedef Ngap_UserLocationInformation_ExtIEs_t
    Ngap_ProtocolIE_SingleContainer_127P24_t;
