...
class Logger {
 public:
  ...
  static _Logger& nssf_app() { return *singleton().m_nssf_app; }
  static _Logger& nssf_sbi() { return *singleton().m_nssf_sbi; }
  static _Logger& nssf_api_server() { return *singleton().m_nssf_api_server; }
